...
import { VALUES_IMAGE, HERO_IMAGE, KITCHEN_IMAGE } from '@/lib/data/properties';
    ...
    <main className="min-h-screen bg-[#FAF8F5] text-[#1F1D1A] pt-32">
      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-12 py-12">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-xl text-[#615C55] leading-relaxed">
      ...
      <section className="py-16 bg-[#F1EBE4] border-y border-[#1F1D1A]/10">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 items-center">
            <div className="lg:col-span-6 relative h-96 w-full overflow-hidden rounded-3xl shadow-lg border border-[#1F1D1A]/10">
              <Image
                src={VALUES_IMAGE}
      ...
      <section className="py-24 mx-auto max-w-7xl px-6 lg:px-12">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-3 text-base text-[#615C55]">
            How we ensure every Vine home feels like a natural extension of your life.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="rounded-3xl bg-[#F1EBE4] p-8 border border-[#1F1D1A]/10 space-y-4">
            ...
            <p className="text-base text-[#615C55] leading-relaxed">
        ...
        {/* CTA Banner */}
        <div className="mt-20 rounded-3xl bg-[#1F1D1A] text-white p-10 sm:p-14 text-center space-y-6">
          <h3 className="font-serif text-3xl sm:text-5xl font-semibold">
            Experience Vine Homes in Person
          </h3>
          <p className="max-w-2xl mx-auto text-lg text-[#E8E2D9]">
